...
public class UserUpdateGroupRequestAdapter extends RecyclerView.Adapter<UserUpdateGroupRequestAdapter.MyHolder>{

    Context context;
    List<RequestGroupModel> bookingModels;

    public UserUpdateGroupRequestAdapter(Context context, List<RequestGroupModel> requestModelList) {
        ...
        public MyHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent UserUpdateMatchRequestActivity = new Intent(context, UserUpdateMatchRequestActivity.class);
                    int position = getAdapterPosition();

                    UserUpdateMatchRequestActivity.putExtra("ReqTimestamp",bookingModels.get(position).getReqTimestamp());
                    UserUpdateMatchRequestActivity.putExtra("ReqAskedUid",bookingModels.get(position).getReqAskedUid());
                    UserUpdateMatchRequestActivity.putExtra("ReqHostUid",bookingModels.get(position).getReqHostUid());


                    UserUpdateMatchRequestActivity.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    context.startActivity(UserUpdateMatchRequestActivity);
