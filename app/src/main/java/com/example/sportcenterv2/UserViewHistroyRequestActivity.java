...
public class UserViewHistroyRequestActivity extends AppCompatActivity {

    Button viewAll,pending,accept,reject;
    RecyclerView recyclerView;
    UserGroupRequestAdapter userViewMatchAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_view_histroy_request);
    ...
    private void loadPending() {
        ...
        ref = FirebaseDatabase.getInstance().getReference("RequestGroup")
                .orderByChild("ReqAskedStatus").equalTo(getStatus);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds: dataSnapshot.getChildren()){
                    ...
                    userViewMatchAdapter = new UserGroupRequestAdapter(getApplicationContext(), groupModels);
    ...
    private void loadAll() {
        ...
        ref = FirebaseDatabase.getInstance().getReference("RequestGroup")
                .orderByChild("ReqAskedUid").equalTo(email);
