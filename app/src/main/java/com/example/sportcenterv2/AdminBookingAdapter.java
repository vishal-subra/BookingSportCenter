...
public class AdminBookingAdapter extends RecyclerView.Adapter<AdminBookingAdapter.MyHolder>{
    ...
    public AdminBookingAdapter(Context context, List<BookingModel> requestModelList) {
        ...
        public MyHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent AdminUpdateBookingActivity = new Intent(context,AdminUpdateBookingActivity.class);
                    int position = getAdapterPosition();

                    AdminUpdateBookingActivity.putExtra("DoTimestamp",bookingModels.get(position).getDoTimestamp());
                    AdminUpdateBookingActivity.putExtra("DoUid",bookingModels.get(position).getDoUid());

                    AdminUpdateBookingActivity.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    context.startActivity(AdminUpdateBookingActivity);
