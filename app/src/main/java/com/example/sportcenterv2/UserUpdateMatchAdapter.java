...
public class UserUpdateMatchAdapter extends RecyclerView.Adapter<UserUpdateMatchAdapter.MyHolder>{

    Context context;
    List<GroupModel> bookingModels;

    public UserUpdateMatchAdapter(Context context, List<GroupModel> requestModelList) {
        ...
        public MyHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent UserUpdateMatchDetailsActivity = new Intent(context, UserUpdateMatchDetailsActivity.class);
                    int position = getAdapterPosition();

                    UserUpdateMatchDetailsActivity.putExtra("MaTimestamp",bookingModels.get(position).getMaTimestamp());
                    UserUpdateMatchDetailsActivity.putExtra("MaUid",bookingModels.get(position).getMaUid());

                    UserUpdateMatchDetailsActivity.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    context.startActivity(UserUpdateMatchDetailsActivity);
